...
<div class="container-fluid p-0">
  <div class="container mt-5">
    <h3 class="mb-4 text-black " style="">Create New Group</h3>
    <form id="groupForm">
      ...
      <div class="row" id="reverse">
        ...
        <div class="col-md-12 mb-3">
          ...
          <!-- <h4 class="mb-3 p-2 rounded shadow-sm bg-primary"
            style="display:flex;justify-content: center;height:60px; align-items: center; color: white;">Members List
          </h4>
          <ul class="list-group members-list" id="membersList"
            style="height: 80vh; overflow-y: auto; border: 1px solid #ddd; padding: 0;">
          </ul>
          <button type="button" class="btn mt-3 mb-3" id="creategroup"
            style="width: 100%; display: flex; justify-content: center; height: 60px; align-items: center; color: #2289f0; background-color: white; border: 2px solid #2289f0;  transition: all 0.3s;">
            Create Group
          </button> -->


          <h4 class="mb-3 p-2 rounded shadow-sm bg-primary"
            style="display:flex;justify-content: center;height:60px; align-items: center;color: white;">Available Users
          </h4>
          ...
          <button type="button" class="btn mt-3 mb-3" id="addToMembersBtn"
            style="width: 100%; display: flex; justify-content: center; height: 60px; align-items: center; color: #f71473; background-color: white; border: 2px solid #f71473;  transition: all 0.3s;">
